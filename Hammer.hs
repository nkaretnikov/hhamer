...
foreign import ccall "hammer.h h_uint32" h_uint32
  :: IO (Ptr C'HParser)

uint32 :: Ptr C'HParser
uint32 = unsafeLocalState h_uint32

-- #ccall h_uint32__m , Ptr <HAllocator_> -> IO (Ptr <HParser_>)
-- #ccall h_uint16 , IO (Ptr <HParser_>)
foreign import ccall "hammer.h h_uint16" h_uint16
  :: IO (Ptr C'HParser)

uint16 :: Ptr C'HParser
uint16 = unsafeLocalState h_uint16

-- #ccall h_uint16__m , Ptr <HAllocator_> -> IO (Ptr <HParser_>)
-- #ccall h_uint8 , IO (Ptr <HParser_>)
foreign import ccall "hammer.h h_uint8" h_uint8
  :: IO (Ptr C'HParser)

uint8 :: Ptr C'HParser
uint8 = unsafeLocalState h_uint8

-- #ccall h_uint8__m , Ptr <HAllocator_> -> IO (Ptr <HParser_>)
-- #ccall h_whitespace , Ptr <HParser_> -> IO (Ptr <HParser_>)
foreign import ccall "hammer.h h_whitespace" h_whitespace
  :: Ptr C'HParser -> IO (Ptr C'HParser)

whitespace :: Ptr C'HParser -> Ptr C'HParser
whitespace = unsafeLocalState . h_whitespace
...
foreign import ccall "hammer.h h_middle" h_middle
  :: Ptr C'HParser -> Ptr C'HParser -> Ptr C'HParser -> IO (Ptr C'HParser)

middle :: Ptr C'HParser -> Ptr C'HParser -> Ptr C'HParser -> Ptr C'HParser
middle x y z = unsafeLocalState $ h_middle x y z
